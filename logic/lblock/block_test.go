...
func TestBlock_VerifyTransactions(t *testing.T) {
	...
	dependentTx1 := transaction.NewTransactionByVin(util.GenerateRandomAoB(1), 1, ta1.GetKeyPair().GetPublicKey(), 10, ta2.GetTransactionAccount(), 3)
	dependentTx2 := transaction.NewTransactionByVin(dependentTx1.ID, 0, ta2.GetKeyPair().GetPublicKey(), 5, ta1.GetTransactionAccount(), 5)
	dependentTx3 := transaction.NewTransactionByVin(dependentTx2.ID, 0, ta1.GetKeyPair().GetPublicKey(), 1, ta2.GetTransactionAccount(), 4)
