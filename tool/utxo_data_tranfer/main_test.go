...
func TestTransferResult(t *testing.T) {
	...
	utxo1 := &utxo.UTXO{transactionbase.TXOutput{common.NewAmount(10000000), minerAccount, ""}, txid1, 0, utxo.UtxoNormal}
	utxo2 := &utxo.UTXO{transactionbase.TXOutput{common.NewAmount(10000000), minerAccount, ""}, txid2, 0, utxo.UtxoNormal}
